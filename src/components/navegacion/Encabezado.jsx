  ...
  if (esCatalogo) {
    ...
    contenidoMenu = (
      <Nav className="ms-auto pe-2">
        ...
        {/* Opción para ir al catalogo público desde admin */}
        <Nav.Link
          onClick={() => manejarNavegacion("/catalogo")}
          className={mostrarMenu ? "color-texto-marca" : "text-white"}
        >
...
{mostrarMenu && (
  <Nav.Link onClick={cerrarSesion} className={mostrarMenu ? "color-texto-marca" : "text-white"}>
...
{mostrarMenu && (
  <div className="mt-3 p-3 rounded bg-light text-dark">
    <p className="mb-2">
      <i className="bi-envelope-fill me-2"></i> {localStorage.getItem("usuario-supabase")?.toLowerCase() || "Usuario"}
    </p>
